...
| hint_type                     | SELECT      | `"none"`                                   | Hint type provided to the user during the game. Options: `"powerup"`, `"stepByStep"`, `"none"`.                                                                                                                                                                       |
| feedback_type                 | SELECT      | `"none"`                                   | Feedback type after answering a question. Options: `"none"`, `"explosion"`, `"explanation"`.                                                                                                                                                                          |
...
timeline.push({
  ...
  on_finish: function (data) {
    ...
    var hintsUsed = data.events.filter(
      (e) => e.eventType === "hint_pressed",
    ).length;
